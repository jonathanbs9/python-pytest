...
class ScanningLoader(TestLoader):
    ...
    def loadTestsFromModule(self, module, pattern=None):
        ...
        If the module is a package, load test from all the modules in it.
        If the module has an ``additional_tests`` function, call it and add
        the return value to the test.
        """
...
class test(Command):
    """Command to run unit test after in-place build"""

    description = "run unit test after in-place build (deprecated)"
