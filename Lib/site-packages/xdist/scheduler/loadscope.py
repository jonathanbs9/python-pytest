...
class LoadScopeScheduling:
    ...
    This distributes the test collected across all nodes so each test is run
    just once.  All nodes collect and submit the list of test and when all
    ...
    to assign more work units if the number of pending test for the node falls
    ...
    :collection: The final list of test collected by all nodes once it is
    ...
    :workqueue: Ordered dictionary that maps all available scopes with their
       associated test (nodeid). Nodeids are in turn associated with their
    ...
    :registered_collections: Ordered dictionary that maps worker nodes with
       their collection of test gathered during test discovery.
    ...
    def _split_scope(self, nodeid):
        ...
        This function will group test with the scope determined by splitting
    ...
    def _pending_of(self, workload):
        """Return the number of pending test in a workload."""
    ...
    def _reschedule(self, node):
        ...
        if the given node should be given any more test.
        """
        ...
        # 2: Heuristic of minimum test to enqueue more work
    ...
    def schedule(self):
        ...
        # Check that all nodes collected the same test
